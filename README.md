...
Git rebase łączy commity tworząc historię commitów za to git merge łaczy kod jednym commitem
<h2>3. W jaki sposób został rozwiązany konflikt w Twoim repozytorium?</h2>
Kod z jednego branch został przeklojony za inny branch